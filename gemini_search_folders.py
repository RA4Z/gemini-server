...
from data_search_folders import historico
import os
...
arquivos = open('Q:\\GROUPS\\BR_SC_JGS_WM_LOGISTICA\\PCP\\Central\\__Automaticos_Python\\06-find_fles\\database\\all.txt', 'r', encoding="utf-8").read()
...
class SearchFoldersAI():
  ...
  def send_message(self, descricao:str):
    ...
    Analisando todos os arquivos acima quero que crie um ranking dos 5 arquivos que mais tem relação com a descrição desejada;
